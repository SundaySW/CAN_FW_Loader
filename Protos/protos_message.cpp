...
ProtosMessage::~ProtosMessage() = default;
...
ProtosMessage::ProtosMessage(uchar destAddr, uchar senderAddr, ProtosMessage::MsgTypes msgType, uchar dlc, uchar data0, uchar data1, uchar data2, uchar data3, uchar data4, uchar data5, uchar data6, uchar data7):
	CanId(0)
{
    Dlc = dlc;
    DestAddr = destAddr;
...
//ProtosMessage::ProtosMessage(Args ...args){
//    SetParamValue(std::forward(args ...));
//}
...
QVariant ProtosMessage::GetParamFieldValue() const
{
	...
	case MsgTypes::PSET:
		...
		case ParamFieldTypes::CHAR:			
			return {CharField & 0x80 ? CharField | 0xffffff00 : CharField};
		case ParamFieldTypes::SHORT:
			return {ShortField & 0x8000 ? ShortField | 0xffff0000 : ShortField};
		...
		case ParamFieldTypes::TIME:			
			return {QTime(0, 0, 0, 0).addMSecs(UlongField)};
